...
void TextureManager::LoadResources()
{
	...
	TexList->Add(eType::TORCH, L"textures\\ground\\0.png", D3DCOLOR_XRGB(2, 1, 2));
	...
	//player
	TexList->Add(eType::SIMON, L"textures\\simon.png", D3DCOLOR_XRGB(8, 3, 24));
	TexList->Add(eType::SIMON_TRANS, L"textures\\simon_trans.png", D3DCOLOR_XRGB(8, 3, 24));
